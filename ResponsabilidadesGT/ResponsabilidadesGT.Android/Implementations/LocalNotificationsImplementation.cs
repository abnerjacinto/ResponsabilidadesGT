[assembly: Xamarin.Forms.Dependency(typeof(ResponsabilidadesGT.Droid.Implementations.LocalNotificationsImplementation))]
...
namespace ResponsabilidadesGT.Droid.Implementations
{
    ...
    using ResponsabilidadesGT.Droid;
    ...
    public class LocalNotificationsImplementation : ILocalNotifications
    {
        ...
        public void Show(string title, string body, bool hasSound, bool hasVibration, int id)
        {
            ...
            {
                builder.SetSmallIcon(Resource.Drawable.Responsabilidades);
            }
        ...
        public void Show(string title, string body, int id, int dias, DateTime notifyTime, bool hasSound, bool hasVibration)
        {
            ...
            {
                localNotification.IconId = Resource.Drawable.Responsabilidades;
            }
